...
helpers: '{project-root}/Y/core/resources/excalidraw/excalidraw-helpers.md'
json_validation: '{project-root}/Y/core/resources/excalidraw/validate-json-instructions.md'
```
